...
public final class JpGoiMon extends javax.swing.JPanel {
    ...
    public JpGoiMon(String trangthai, String tenban, int maban) {
        ...
        arrhd = cn.GetHDbyMaBan(maban);// Lấy toàn bộ thồng tin HOADON theo MaBan
        if(arrhd != null){
            order = cn.GetDsOrder(arrhd.GetMaHD());//nạp tt cho order = Select ct.MaMon, TenMon, DVT, SoLuong, Gia, MaHoaDon
            fillDsMon(0);
            MaHD = arrhd.GetMaHD();// nạp MaHoaDon 
            lblgioden.setText(df.format(arrhd.GetGioDen()));  //___________ gio _________
        }
        lblTenBan.setText(tenban);
        lbltrangthai.setText(trangthai);

        if(lbltrangthai.getText().equals("Trong")){
    ...
    public void fillDsMon(int mahd){
        ...
        if(order != null){
            ...
            for(int i=0;i<order.size();i++){
                ...
                pn[i].add(lbl).addMouseListener(new MouseAdapter() {
                  @Override
                    public void mouseClicked(MouseEvent e){
                        int qs;
                        ArrayList<Mon> td = cn.GetMonByMa(e.getComponent().getName());
                ...
                pn[i].addMouseListener(new MouseAdapter() {///CHU Y QUAN TRONG 
                    @Override
    ...
    private void HuyHD(){
        ...
        btnhuy.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e){
                ...
                jpBanHang.bh.FillBan();// chú ý 
                JpGoiMon.gm.removeAll();// chú ý 
                jpBanHang.bh.fillLb();
    ...
    private void btngoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btngoiActionPerformed
        if(btngoi.getText().equals("Hủy bàn")){
            ...
            thanhtoan.setVisible(true);// CHÚ Ý lấy dc tổng tiền , trạng thái , Mã bàn , Ma HD
            return;         
        }
        if(btngoi.getText().equals("Gọi món")){
            ...
            lbltrangthai.setText("Dang phuc vu");
            btndatban.setVisible(false);
            btnthugon.setVisible(false);
...
//         if(lbltrangthai.getText().equals("Dang phuc vu"))
//         {
//            String TrangThai = "Dang phuc vu";
//            Ban b = new Ban(MaBan, TenBan, TrangThai);/////////////////CHU Y
//            int Update = cn.UpdateBan(b);
...
//         }
    ...
    private void btndatbanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndatbanActionPerformed
        if(lbltrangthai.getText().equals("Da dat truoc")){
            ...
            lbltrangthai.setText("Da dat truoc");
            btndatban.setText("Hủy đặt");
            String TrangThai = "Da dat truoc";
            Ban b = new Ban(MaBan, TenBan, TrangThai);
            int Update = cn.UpdateBan(b);
            jpBanHang.bh.FillBan();
            jpBanHang.bh.updateUI();
