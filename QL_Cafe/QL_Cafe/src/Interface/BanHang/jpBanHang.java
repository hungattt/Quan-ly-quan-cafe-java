...
public final class jpBanHang extends javax.swing.JPanel {
    ...
    public void FillBan(){
        ...
        if(arrBan != null){
            ...
            for(int i=0;i<arrBan.size();i++){
                ...
                btn[i].setText(mb[1]);
                btn[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Images/iconban4.png")));
                ...
                if(arrBan.get(i).GetTrangThai().equals("Trong")){
                    btn[i].setBackground(Color.decode("#8080ff"));
                }                
                btn[i].setPreferredSize(new Dimension(90, 90));

                btn[i].addMouseListener(new MouseAdapter() {
                        @Override
                        public void mousePressed(MouseEvent e) {
                            JpGoiMon goimon;////////(((((    CHU Y )))))))------------------------------------------
                            ...
                            if(ban != null){                            
                                ...
                                jPanel2.removeAll();///( Lấy dc trang thái ,tên,mã Của BÀN ) --------------------------------
                                jPanel2.add(goimon);
                                jPanel2.updateUI();
                            }
                        }                    
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Images/menu6.jpg"))); // NOI18N
        ...
        jLabel4.setText("Dang phuc vu");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("Da dat truoc");
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jpBan, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jLabel3.getAccessibleContext().setAccessibleName("Trong");
        jLabel3.getAccessibleContext().setAccessibleDescription("");
        jLabel4.getAccessibleContext().setAccessibleName("Dang phuc vu");
        jLabel4.getAccessibleContext().setAccessibleDescription("");
        jLabel5.getAccessibleContext().setAccessibleName("Da dat truoc");
