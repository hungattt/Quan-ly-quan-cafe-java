...
public class JpDoiMk extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtpassworder = new javax.swing.JTextField();
        ...
        txtpassworder.setToolTipText("");

        txtpassmoi.setToolTipText("");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(68, 68, 68))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtpassworder, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtpasswordnew)
                                    .addComponent(txtpassmoi, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtpassworder, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!validate(txtpassworder,txtpassworder.getText(),"Mật khẩu cũ")){
            return;
        }
        if(!txtpassworder.getText().equals(Run.tk.GetPassword())){
            JOptionPane.showMessageDialog(null, "Mật khẩu cũ không đúng !");
            return;
        }
            
        if(!validate(txtpasswordnew,txtpasswordnew.getText(),"Mật khẩu mới")){
            return;
        }

        if(!validate(txtpassmoi,txtpassmoi.getText(),"Nhập lại mật khẩu")){
            return;
        }
        if(!txtpassmoi.getText().equals(txtpasswordnew.getText())){
            JOptionPane.showMessageDialog(null, "Nhập lại không khớp !");
            return;
        }
        TaiKhoan tk = new TaiKhoan();
        tk.SetID(Run.tk.GetID());
        tk.SetPassword(txtpassmoi.getText());
...
// TODO add your handling code here:
    ...
    private javax.swing.JTextField txtpassworder;
