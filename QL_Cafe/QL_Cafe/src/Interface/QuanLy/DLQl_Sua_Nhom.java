...
public class DLQl_Sua_Nhom extends javax.swing.JDialog {
    ...
    public DLQl_Sua_Nhom(java.awt.Frame parent, boolean modal, String manhom) {
        ...
        initComponents();
        MaNhom = manhom;
        DanhMuc l = cn.GetDanhMucByMa(manhom);
        mausac = l.GetMauSac();
        txtten.setText(l.GetTenDanhMuc());
        jpmau.setBackground(Color.decode(mausac));
        lblten.setText("Sửa nhóm - "+l.GetTenDanhMuc());  
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        loai.SetTenDanhMuc(txtten.getText());
        loai.SetMauSac(hex);
        loai.SetMaDanhMuc(MaNhom);
        int update = cn.UpdateDanhMuc(loai);
        if(update > 0){
