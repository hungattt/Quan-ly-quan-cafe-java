 ...
 * @author ThangIKCU
 */
public class Dl_Sua_Mon extends javax.swing.JDialog {
    ConnectSQL cn = new ConnectSQL();
    /**
     * Creates new form Dl_Sua_Mon
     */
    ArrayList<Mon> td ;
    String MaMon;
    public Dl_Sua_Mon(java.awt.Frame parent, boolean modal, String mamon) {
        super(parent, modal);
        initComponents();
        MaMon = mamon;
        td = cn.GetMonByMa(mamon);
        Fillcbb();
    ...
    private void Fillcbb() {
        ...
        if (Vcbb != null) {
            ...
            for(int i =0; i<cbbNhomMon.getItemCount();i++){
                DanhMuc l = ((DanhMuc)cbbNhomMon.getItemAt(i));
                if(td.get(0).GetMaDanhMuc().equals(l.GetMaDanhMuc())){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String MaNhom = ((DanhMuc)cbbNhomMon.getSelectedItem()).GetMaDanhMuc();
        mon.SetMaDanhMuc(MaNhom);

        int Insert = cn.UpdateMon(mon);
        if(Insert == 0){
            JOptionPane.showMessageDialog(null, "Sửa không thành công!");
            return;
        }
        Jp_QLMon.td.FillTable(MaNhom);
