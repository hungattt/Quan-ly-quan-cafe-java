 ...
 * @author ThangIKCU
 */
public class Jp_QLMon extends javax.swing.JPanel {
    ConnectSQL cn = new ConnectSQL();
    
    /**
     * Creates new form Jp_QLMon
     */
    public static Jp_QLMon td;
    public Jp_QLMon() {
        td = this;
        initComponents();
        Fillcbb();
    ...
    public void FillTable(String nhom) {
        ArrayList<Mon> arrTable = cn.GetMon(nhom);
        ...
        if (arrTable != null) {
            ...
            for (Mon td : arrTable) {
                somon++;
                tbmodel.addRow(new Object[]{td.GetMaMon(), td.GetTenMon(), td.GetMaDanhMuc(), td.GetDonGia(), td.GetDVT()});
            }
    ...
    private void bntThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemActionPerformed
        Dl_Them_Mon td = new Dl_Them_Mon(Run.QlCafe, true);
        td.setVisible(true);
    ...
    private void bntSuaMonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaMonActionPerformed
        ...
        if(select<0){
            ...
            Dl_Sua_Mon sua = new Dl_Sua_Mon(Run.QlCafe, true, mamon);
            sua.setVisible(true);
        }
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        ...
        if (selectedRows.length <= 0) {
            ...
            for (int i : selectedRows) {
                 ma = (String) tbBan.getValueAt(i, 0);
                //ListMaBan.add(ma);
            ...
            if (qs == JOptionPane.YES_OPTION) {
                //boolean xoa = cn.DeleteMon(ListMaBan);
                boolean xoa = cn.DeleteMon(ma);
                if (xoa == true) {
                    FillTable(null);
                    try{
    ...
    private void cbbNhomMonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbbNhomMonItemStateChanged
        DanhMuc selected = (DanhMuc) cbbNhomMon.getSelectedItem();
        FillTable(selected.GetMaDanhMuc());
        // TODO add your handling code here:
    }//GEN-LAST:event_cbbNhomMonItemStateChanged

    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        
        ArrayList<Mon> arrTable = cn.SearchMon(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
