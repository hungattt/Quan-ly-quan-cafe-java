...
public class Jp_QLNhomMon extends javax.swing.JPanel {
    ...
    public Jp_QLNhomMon() {
      ...
      public void FillTable() {
        ArrayList<DanhMuc> arrTable = cn.GetDanhMuc();
        ...
        if (arrTable != null) {
            int soloai = 0;
            for (DanhMuc l : arrTable) {
                soloai++;
                tbmodel.addRow(new Object[]{l.GetMaDanhMuc(), l.GetTenDanhMuc(),l.GetMauSac()});
            }
    ...
    private void bntThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemActionPerformed
        DLQl_Them_DanhMuc l = new DLQl_Them_DanhMuc(Run.QlCafe, true);
        l.setVisible(true);
    ...
    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        ArrayList<DanhMuc> arrTable = cn.SearchDanhMuc(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
