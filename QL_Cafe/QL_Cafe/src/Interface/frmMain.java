    ...
    public void run(){ 
        while(true){ 
            ...
            for(int i = 0;i<arrBan.size();i++){
                if(arrBan.get(i).GetTrangThai().equals("Dang phuc vu")){
                    banpv++;
                }
                if(arrBan.get(i).GetTrangThai().equals("Da dat truoc")){
                    bandat++;
                }            
            } 
            lblpv.setText(+banpv+" ban dang phuc vu");
            lbldat.setText(+bandat+" ban dat truoc");
...
//        jpLayout.add(banhang);
        ...
        jpLayout.add(home);
        jpLayout.updateUI();
        mp3 = new MP3 ("src/Sound/windowns khoi dong.MP3");//src/Sound/Ai la trieu phu - ai la trieu phu.MP3
        mp3.play();
...
//                break;
            case 5:
                ...
                //btnThietLap.setPressedIcon(new ImageIcon("src/Interface/Images/theme.png"));
                mp3 = new MP3 ("src/Sound/kasya.MP3");
                mp3.play();
                jpLayout.add(Set);
                break;                
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnTrangChu, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(42, 42, 42)
                .addComponent(btnBanHang, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36)
                .addComponent(btnQuanLy, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37)
                .addComponent(btnThongKe, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
                .addComponent(btnThietLap, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public void thoat()
    {
        ...
        int kq=JOptionPane.showConfirmDialog(null, "Bạn có muốn đóng phần mềm ?","Cafe Warning",JOptionPane.YES_NO_OPTION);
        if(kq==0)
        {
        System.exit(0);
       }
    ...
    private void btnthoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthoatActionPerformed
        ...
        int kq=JOptionPane.showConfirmDialog(null, "Đăng xuất khỏi tài khoản " +Run.tk.GetUsername()+ "?","Cafe Warning",JOptionPane.YES_NO_OPTION);
        if(kq==0)
        {
            MP3 mp3 = new MP3 ("src/Sound/windowns tat.MP3");
            mp3.play();
...
//        Run.rerun();
    ...
    private void btnSoundActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSoundActionPerformed
        // TODO add your handling code here:
        nhacnen = new MP3 ("src/Sound/dung yeu nua em met roi.MP3");
        nhacnen.play();
