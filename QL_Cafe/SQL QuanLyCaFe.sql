...
CREATE TABLE CHITIETHD (
  MaChiTietHD nvarchar(10) primary key,
  MaHoaDon nvarchar(10) foreign key references HOADON ,
  MaMon nvarchar(10) foreign key references MON ,
  SoLuong int ,
  Gia int 
) ;
...
CREATE TABLE HOADON (
  ...
  MaBan nvarchar(10) foreign key references BAN,
...
VALUES(159, NULL, 5, '2016-02-17 19:44:48', 250000, 1),
...
INSERT INTO TAIKHOAN (Id, Username, Password, lv) 
VALUES(6, 'thanggun99', 'a', 1),
	(7, 'nhanvien', '1', 2),
	(10, 'nhanvien2', '1', 2),
	(11, 'admin', 'admin', 1);
...
CREATE TABLE MON (
  ...
  TenMon varchar(55) ,
  MaDM nvarchar(10) foreign key references DANHMUC,
  DonGia int,
  DVT varchar(55) 
) ;
